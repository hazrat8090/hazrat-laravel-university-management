    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-1">
                <h4 class="card-title">Mazar University Faculties</h4>
                <div>
                    <a href="">
            ...
            <div class="table-container overflow-x-auto">
                <table class="table table-bordered" id="example">
                    ...
                    <tbody>
                        @foreach($facultyOfMazar as $faculty)
                        <tr class="table-info">
                            <td> {{ $faculty->id }} </td>
                            <td> {{ $faculty->name }} </td>
                            ...
                            <td>
                                ...
                                <div class="d-inline-block">
                                    <a href="{{ route('MuniversityCEdepartments', ['university_id'=>$faculty->university_id, 'id' => $faculty->id]) }}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> View Departments</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach()
